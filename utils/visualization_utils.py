...
def draw_bounding_box_on_image_array(image,
  ...
  draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
                             ...
                             use_normalized_coordinates, count)
...
def draw_bounding_box_on_image(image,
                               ...
                               thickness=4,
                               display_str_list=(),
                               use_normalized_coordinates=True, count = None):
  ...
  if count is not None:
    font_count = ImageFont.truetype('arial.ttf', 14)
    draw.text((5, im_height - 20), "Fish count: " + str(count), font = font_count, fill='white')
  font = ImageFont.truetype('arial.ttf', 8)
...
def visualize_boxes_and_labels_on_image_array(
  ...
  for box, color in box_to_color_map.items():
    ...
    show_boxes = scores > min_score_thresh
